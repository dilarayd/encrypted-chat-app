...
namespace Chat_App
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Form1 form1x = (Form1)Application.OpenForms["Form1"];
            ...
            form1x.listView1.Items.Add(row2);
            form1x.listView1.Items[color].BackColor = Color.LightGreen;
            ...
            form1x.form3x.listView1.Items.Add(row3);
            form1x.form3x.listView1.Items[color].BackColor = Color.LightBlue; 
